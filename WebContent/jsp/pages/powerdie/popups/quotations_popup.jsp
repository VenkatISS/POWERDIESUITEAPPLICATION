...
<title><%=agencyVO.getGstin_no()+"-"+"QUOTATION"+"-"+request.getAttribute("dateyear")%></title>
...
<jsp:useBean id="qts_data" scope="request" class="java.lang.String"></jsp:useBean>
...
var page_data = <%= qts_data.length()>0? qts_data : "" %>;
...
<body style="width: 93%;padding: -1px;margin-left:25px;">
	<table style="width: 90%; margin-left:70px">
		<tr valign="top">
			<td><br><br><br>
			<center><span style="font-size:17px;">QUOTATION</span></center>			
							...
							<table style="width: 100%;border: 1px solid;border-color: #808B96;font-size: 12px;padding: 10px;" class="table">
								<tr valign="top">
									<td width="50%" style="border: 1px solid;border-color: #808B96;font-size: 12px;" class="td">
										QUOTATION NUMBER : <span id="invid"></span> <br>
										QUOTATION DATE : <span id="invdate"></span> <br>
									</td>
									<td width="50%" style="border: 1px solid;border-color: #808B96;font-size: 12px;" class="td">
...
<!-- 											<tr valign="top">
												<td colspan="3" style="font-size: 14px;">NARRATION : <span id="nars"></span><br><br></td>
											</tr> -->
											<tr valign="top">
												<td colspan="3" style="font-size: 14px;">DECLARATION :  This is system generated.Hence no stamp and signature is required.<br></td>
											</tr>
											<tr><td>&nbsp</td></tr>
											<tr><td>&nbsp</td></tr>
											<tr><td>&nbsp</td></tr>
									...
									<td>									
										<table id="data_table3" class="table" style="width: 100%;margin-left: -1%;border: 1px solid;border-color: #808B96;font-size: 15px;padding: 10px;border-collapse:collapse;">
										 	<tr>
												<td class="td" colspan="2" width="24.5%" style="border: 1px solid;border-color: #808B96;font-size: 14px;">TAXABLE <b>: 
												<span id="taxableVal" style="font-size: 14px;"></span></b></td>
											</tr>
											<tr>
												<td class="td" colspan="2" width="24.5%" style="border: 1px solid;border-color: #808B96;font-size: 14px;">IGST <b>:
												<span id="igstVal" style="font-size: 14px;"></span></b></td>
											</tr>
											<tr>
												<td class="td" colspan="2" width="24.5%" style="border: 1px solid;border-color: #808B96;font-size: 14px;">CGST <b>:
												<span id="cgstVal" style="font-size: 14px;"></span></b></td>
											</tr>
											<tr>
												<td class="td" colspan="2" width="24.5%" style="border: 1px solid;border-color: #808B96;font-size: 14px;">SGST <b>:
												<span id="sgstVal" style="font-size: 14px;"></span></b></td>
											</tr>
											<tr>
												<td class="td" colspan="2" width="24.5%" style="border: 1px solid;border-color: #808B96;font-size: 15px;"><b>TOTAL :
												<span id="tinvamt" style="font-size: 15px;"></span></b></td>
											</tr>
										</table>
...
<script type="text/javascript" src="js/modules/popups/quotations_popup.js?<%=randomUUIDString%>"></script>
</html>